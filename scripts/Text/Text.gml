...
draw_text(room_width/2-1,room_height/2+16*3.5,print);
draw_text(room_width/2+1,room_height/2+16*3.5,print);
draw_text(room_width/2,room_height/2+16*3.5-1,print);
draw_text(room_width/2,room_height/2+16*3.5+1,print);
draw_set_color(c_white);
draw_text(room_width/2,room_height/2+16*3.5,print);
timerText++;
